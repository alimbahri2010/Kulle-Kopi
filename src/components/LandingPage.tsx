...
const GALLERY_PHOTOS = [
  { url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600"><rect width="800" height="600" fill="%25230F172A"/><rect x="150" y="150" width="500" height="300" rx="20" fill="%25231E293B" stroke="%252338BDF8" stroke-width="4"/><text x="400" y="310" font-family="sans-serif" font-weight="bold" font-size="24" fill="%2523F8FAFC" text-anchor="middle">AREA DUDUK INDOOR ESTETIK</text></svg>', title: 'Area Duduk Indoor yang Estetik', category: 'interior' },
  { url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600"><rect width="800" height="600" fill="%25231E1B4B"/><rect x="150" y="150" width="500" height="300" rx="20" fill="%2523312E81" stroke="%2523818CF8" stroke-width="4"/><text x="400" y="310" font-family="sans-serif" font-weight="bold" font-size="24" fill="%2523F8FAFC" text-anchor="middle">PROSES PEMBUATAN KOPI SARING</text></svg>', title: 'Proses Pembuatan Kopi Saring', category: 'seduh' },
  { url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600"><rect width="800" height="600" fill="%2523062F4F"/><rect x="150" y="150" width="500" height="300" rx="20" fill="%252313334C" stroke="%252300C9A7" stroke-width="4"/><text x="400" y="310" font-family="sans-serif" font-weight="bold" font-size="24" fill="%2523F8FAFC" text-anchor="middle">AREA DECK TERBUKA (AL FRESCO)</text></svg>', title: 'Area Deck Terbuka (Al Fresco)', category: 'interior' },
  { url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600"><rect width="800" height="600" fill="%25234A2E1B"/><rect x="150" y="150" width="500" height="300" rx="20" fill="%25235C3A21" stroke="%2523D97706" stroke-width="4"/><text x="400" y="310" font-family="sans-serif" font-weight="bold" font-size="24" fill="%2523F8FAFC" text-anchor="middle">KOPI FLAT WHITE YANG LEMBUT</text></svg>', title: 'Kopi Flat White yang Lembut', category: 'kopi' },
  { url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600"><rect width="800" height="600" fill="%25232C1D11"/><rect x="150" y="150" width="500" height="300" rx="20" fill="%25234A2E1B" stroke="%2523A16207" stroke-width="4"/><text x="400" y="310" font-family="sans-serif" font-weight="bold" font-size="24" fill="%2523F8FAFC" text-anchor="middle">EKSTRAKSI ESPRESSO KHAS KULLE</text></svg>', title: 'Ekstraksi Espresso Khas Kulle', category: 'seduh' },
  { url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600"><rect width="800" height="600" fill="%25237C2D12"/><rect x="150" y="150" width="500" height="300" rx="20" fill="%25239A3412" stroke="%2523F97316" stroke-width="4"/><text x="400" y="310" font-family="sans-serif" font-weight="bold" font-size="24" fill="%2523F8FAFC" text-anchor="middle">NASI GORENG KULLE YANG LEZAT</text></svg>', title: 'Nasi Goreng Kulle yang Lezat', category: 'kuliner' },
];
